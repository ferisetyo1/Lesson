...
class DaftarKelasFragment : Fragment(), View.OnClickListener, TextWatcher {
    ...
    private fun setAdapter(s:String?): FirebaseRecyclerAdapter<KelasModel, DaftarKelasViewHolder>? = object : FirebaseRecyclerAdapter<KelasModel, DaftarKelasViewHolder>(rv_option!!) {
